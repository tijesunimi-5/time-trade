      ...
      <div className="flex-1 p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 max-w-6xl mx-auto">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-500">
            Participant rankings based on consistency percentage and streak adherence (EXCO members excluded).
          </p>
        </div>

        {isLoading ? (
          <Loader variant="card" text="Loading participant leaderboard..." />
        ) : (
                  ...
                  {rankings.length === 0 ? (
                    <tr>
                      <td colSpan={5} className="p-8 text-center text-xs text-slate-500">
                        No participant rankings available yet.
                      </td>
                    </tr>
                  ) : (
                    rankings.map((r) => (
